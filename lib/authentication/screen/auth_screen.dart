...
import 'package:projeto/authentication/components/show_snackbar.dart';
  ...
  redefinirSenha() {
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: Text('Confimer o e-mail para redefinição de senha.'),
          content: TextFormField(
            controller: redefinirSenhaController,
            decoration: InputDecoration(label: Text('Confimer o e-mail.')),
          ),
          ...
          actions: [
            TextButton(
                onPressed: () {
                  authService
                      .redefinicaoSenha(email: redefinirSenhaController.text)
                      .then((String? erro) {
                    if (erro == null) {
                      showSnackBar(
                          context: context,
                          mensagem:
                              'Codigo de redefinicão enviada par seu email!',
                          isErro: false);
                    } else {
                      showSnackBar(context: context, mensagem: erro);
                    }
